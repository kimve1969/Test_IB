...
// CTest_IBDlg dialog
class CTest_IBDlg : public CDialogEx, public EWrapper
{
// Construction
public:
	CTest_IBDlg(CWnd* pParent = NULL);	// standard constructor

// Dialog Data
	enum { IDD = IDD_TEST_IB_DIALOG };
